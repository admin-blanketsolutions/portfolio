...
### Phase 3 — TB ingestion & AI mapping (weeks 16–28) · **slice 1 delivered in this repository**
...
| Still to build | container sandbox runner (network-less Fargate/Lambda) and S3 + Object Lock adapter; embedding kNN stage; evaluation harness and red-team CI gate against a real model; multi-currency / IAS 21; review UI | ☐ |
